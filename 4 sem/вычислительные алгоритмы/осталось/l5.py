...
#Find x1-x5, v методом итераций (находим дельта х1-х5, v), при каждой итерации прибавляем дельты к значениям матрицы.
# Итерируюсь до тех пор пока одно из значений (максимальное) относ погрешности больше eps = 1e-5
# Решаем матрицу методом Гаусса, находим гамму с помощью метода половинного деления
