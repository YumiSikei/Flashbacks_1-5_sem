...
3. Install PTC Mathcad Prime 4.0 F000 Win32


4. Replace original <Mathcad Prime 4.0 program folder> (by default C:\Program Files\PTC\Mathcad Prime 4.0 ) with folder from  archive Mathcad.Prime.4.0.F000.Win32-SSQ.7z
