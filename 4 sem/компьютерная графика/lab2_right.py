...
X = copy.copy(X_start); X_past = copy.copy(X_start)
Y = copy.copy(Y_start); Y_past = copy.copy(Y_start)
...
def do_start():
    ...
    X = copy.copy(X_start); Y = copy.copy(Y_start)
    print(X[0],' ',Y[0],' ',X[1],' ',Y[1])
...
def do_step_back():
    ...
    X = copy.copy(X_past); Y = copy.copy(Y_past)
    print('step back')
